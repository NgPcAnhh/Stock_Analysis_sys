        ...
        <footer className="w-full bg-[#0f172a] text-white pt-16 pb-8">
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-2 font-bold text-2xl text-[#f97316]">
                            <img
                                src="/favicon.ico"
                                alt="StockPro Logo"
                                className="h-10 w-10 object-contain rounded-xl bg-white/10"
                            />
                            <span>StockPro</span>
                        </div>
                    ...
                    <div>
                        <h4 className="font-bold text-lg mb-6 text-white">Về StockPro</h4>
                ...
                <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-500">
                    <p>© 2024 StockPro JSC. All rights reserved.</p>
